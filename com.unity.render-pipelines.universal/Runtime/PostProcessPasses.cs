...
namespace UnityEngine.Rendering.Universal
{
    ...
    internal struct PostProcessPasses : IDisposable
    {
        ...
        {
            return // handle.rt.depth != desc.depthBufferBits ||
                   (handle.rt.graphicsFormat != GraphicsFormat.DepthAuto && handle.rt.graphicsFormat != desc.graphicsFormat) ||
