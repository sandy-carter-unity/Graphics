namespace UnityEngine.Rendering.Universal
{
    ...
    internal static class URPShaderIDs
    {
        ...
        public static readonly int _SSAOTexture1ID = Shader.PropertyToID("_SSAO_OcclusionTexture1");
        public static readonly int _SSAOTexture2ID = Shader.PropertyToID("_SSAO_OcclusionTexture2");
        public static readonly int _SSAOTexture3ID = Shader.PropertyToID("_SSAO_OcclusionTexture3");
